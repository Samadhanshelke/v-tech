    ...
    <div className=" container px-4 text-white mt-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-9 ">
            <ul className="space-y-4 text-xl">
                ...
                <li><a href="https://vgtechtailtwo.netlify.app/"> Blog</a></li>
            </ul>
            <ul className="space-y-4 text-xl">
                ...
                <li><a href="https://vgtechtailtwo.netlify.app/"> Blogs </a></li>
                <li><a href="https://vgtechtailtwo.netlify.app/"> News</a></li>
            </ul>
            <ul className="space-y-4 text-xl">
            ...
            <ul className="space-y-6 text-xl">
                ...
                <li className="text-2xl text-theme-default font-bold">Adress</li>
